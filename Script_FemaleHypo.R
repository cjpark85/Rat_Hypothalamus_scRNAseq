...
ifemale.data <- Read10X(data.dir = "D:/Single-cell_hypo_P29/P29_intact_F/outs/filtered_feature_bc_matrix/")
...
efemale.data <- Read10X(data.dir = "D:/Single-cell_hypo_P29/P29_EB300_F/outs/filtered_feature_bc_matrix/")
